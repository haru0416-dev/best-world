Shader "BestWorld/Lit Transparent"
{
    Properties
    {
        [Header(Maps)]
        ...
        [ToggleUI] _BicubicLightmap ("Bicubic Lightmap and Shadowmask", Float) = 0
        ...
        [Toggle(_ALPHAPREMULTIPLY_ON)] _ALPHAPREMULTIPLY_ON ("Premultiply", Float) = 0
    ...
    SubShader
    {
        Tags
        {
            ...
            "LTCGI" = "_LTCGI"
            "VRCFallback" = "Transparent/Diffuse"
        }
